...
class Root(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=1, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.conv = nn.Conv2d(
...
class Tree(nn.Module):
    def __init__(self, block, in_channels, out_channels, level=1, stride=1, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class SimpleDLA(nn.Module):
    def __init__(self, block=BasicBlock, num_classes=10, *args, **kwargs):
        super().__init__(*args, **kwargs)
